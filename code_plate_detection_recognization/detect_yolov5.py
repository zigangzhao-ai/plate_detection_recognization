...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\code_plate_detection_recognization_1\weights\yolov5_best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'D:\code_plate_detection_recognization_1\demo\images', help='file/dir/URL/glob, 0 for webcam')
